...
export function Add_Icon({ w = 23, color = "#fff" }: { w?: number; color?: string }) {
    return (
        <svg width={w} height={w} viewBox="0 0 26 26" fill='none' xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M6.02201 8.14351C3.70939 11.4581 4.03184 16.0528 6.98938 19.0104C10.3088 22.3298 15.6907 22.3298 19.0102 19.0104C22.3297 15.6909 22.3297 10.309 19.0102 6.98956C16.0527 4.03202 11.4579 3.70957 8.14333 6.02219" stroke={color} stroke-linecap="round" />
            <path d="M13 9L13 17" stroke={color} stroke-width="1.2" stroke-linecap="round" />
            <path d="M17 13L9 13" stroke={color} stroke-width="1.2" stroke-linecap="round" />
        </svg>
...
export function Close_Icon({ w = 23, color = "#fff" }: { w?: number; color?: string }) {
    return (
        <svg width={w} height={w} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M17 9L9 17" stroke={color} stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M9 9L17 17" stroke={color} stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M6.02201 8.14351C3.70939 11.4581 4.03184 16.0528 6.98938 19.0104C10.3088 22.3298 15.6907 22.3298 19.0102 19.0104C22.3297 15.6909 22.3297 10.309 19.0102 6.98956C16.0527 4.03202 11.4579 3.70957 8.14333 6.02219" stroke={color} stroke-linecap="round" />
        </svg>
...
export function Check_Icon({ w = 23, color = "#fff" }: { w?: number; color?: string }) {
    return (
